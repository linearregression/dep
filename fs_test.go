...
func TestIsRegular(t *testing.T) {
	...
	tests := []struct {
		...
		{name: filepath.Join(wd, "_testdata"), want: false, werr: false},
...
func TestIsDir(t *testing.T) {
	...
	tests := []struct {
		...
		{name: filepath.Join(wd, "_testdata"), want: true, werr: false},
...
func TestIsEmptyDirOrNotExist(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "_testdata", want: false, werr: false},    // not empty, exists
